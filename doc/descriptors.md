# Support for Output Descriptors in OnRemit Core

Since OnRemit Core v0.17, there is support for Output Descriptors. This is a
...
existing OnRemit Core wallets, a convenience function `combo` is
