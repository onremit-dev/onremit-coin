Contributing to OnRemit Core
============================

The OnRemit Core project operates an open contributor model where anyone is
...
Before you start contributing, familiarize yourself with the OnRemit Core build
...
The developer
[mailing list](https://groups.google.com/forum/#!forum/onremit-dev)
...
the pull request affects. Valid areas as:
  ...
  - `qt` or `gui` for changes to onremit-qt
...
The following applies to code changes to the OnRemit Core project (and related
projects such as libsecp256k1), and is not to be confused with overall OnRemit
Network Protocol consensus changes.

Whether a pull request is merged into OnRemit Core rests with the project merge
...
Patches that change OnRemit consensus rules are considerably more involved than
...
Where a patch set proposes to change the OnRemit consensus, it must have been
...
The project leader is the release manager for each OnRemit Core release.
