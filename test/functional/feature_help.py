...
"""Verify that starting onremit with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start onremit with -h for help text")
        ...
        self.log.info("Start onremit with -version for version information")
        ...
        self.log.info("Start onremitd with -fakearg to make sure it does not start")
