...
public:
    CMainParams() {
        ...
        vSeeds.emplace_back("seed-a.onremit.loshan.co.uk");
        vSeeds.emplace_back("dnsseed.thrasher.io");
        vSeeds.emplace_back("dnsseed.onremittools.com");
        vSeeds.emplace_back("dnsseed.onremitpool.org");
...
public:
    CTestNetParams() {
        ...
        vSeeds.emplace_back("testnet-seed.onremittools.com");
        vSeeds.emplace_back("seed-b.onremit.loshan.co.uk");
