...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " onremit-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  onremit-tx [options] <hex-tx> [commands]  Update hex-encoded onremit transaction\n" +
            "or:     onremit-tx [options] -create [commands]   Create hex-encoded onremit transaction\n" +
            "\n";
