...
const char * const BITCOIN_CONF_FILENAME = "onremit.conf";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "OnRemit";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/OnRemit";
#else
    // Unix-like
    return pathRet / ".onremit";
#endif
#endif
}
